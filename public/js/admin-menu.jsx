...
function App() {
  ...
  return (
    <div className="shell">
      <AdminSidebar activeLabel="Thực đơn" badges={{ "Thực đơn": String(items.length) }} admin={{ name: adminName, email: adminEmail, initials: adminInitials }} sideOpen={sideOpen} onClose={() => setSideOpen(false)} />
