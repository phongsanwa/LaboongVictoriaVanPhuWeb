...
@php($lbGen = \App\Models\AppSetting::get('general', []))
@php($lbAppIcon = ($lbGen['app_icon_url'] ?? null) ?: ($lbGen['logo_url'] ?? null))
<link rel="manifest" href="{{ route('pwa.manifest') }}" />
{{-- Icon màn hình chính trên iPhone (apple-touch-icon): ưu tiên ảnh riêng, rồi tới logo, cuối cùng ảnh mặc định. --}}
<link rel="apple-touch-icon" href="{{ $lbAppIcon ? url($lbAppIcon) : asset('icons/apple-touch-icon.png') }}" />
