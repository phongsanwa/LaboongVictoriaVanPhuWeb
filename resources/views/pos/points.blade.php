...
<title>Laboong · Tích điểm cho khách</title>
...
<script type="text/babel" src="{{ asset('js/pos.jsx') }}?v={{ filemtime(public_path('js/pos.jsx')) }}"></script>
</body>
</html>
