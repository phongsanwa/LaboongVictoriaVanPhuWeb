...
<title>Laboong · Đơn hàng của tôi</title>
...
<link rel="stylesheet" href="{{ asset('css/order-history.css') }}?v={{ filemtime(public_path('css/order-history.css')) }}" />
</head>
<body>
<div id="root"></div>
...
<script>
  window.ORDER_HISTORY_DATA = @json($historyData);
</script>
...
<script type="text/babel" src="{{ asset('js/order-history.jsx') }}?v={{ filemtime(public_path('js/order-history.jsx')) }}"></script>
</body>
</html>
