...
<title>Laboong Admin · Báo cáo đơn hàng</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-orders.jsx') }}?v={{ filemtime(public_path('js/admin-report-orders.jsx')) }}"></script>
</body>
</html>
