...
<title>Laboong Admin · Báo cáo khách hàng mới</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-new.jsx') }}?v={{ filemtime(public_path('js/admin-report-new.jsx')) }}"></script>
</body>
</html>
