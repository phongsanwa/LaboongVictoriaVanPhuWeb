...
<title>Laboong Admin · Báo cáo khách hàng</title>
...
{{-- Thư viện báo cáo (tải phía trình duyệt) --}}
...
<script type="text/babel" src="{{ asset('js/admin-report-customers.jsx') }}?v={{ filemtime(public_path('js/admin-report-customers.jsx')) }}"></script>
</body>
</html>
