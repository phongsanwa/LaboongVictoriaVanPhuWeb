...
<title>Laboong Admin · Báo cáo điểm thưởng</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-points.jsx') }}?v={{ filemtime(public_path('js/admin-report-points.jsx')) }}"></script>
</body>
</html>
