...
<title>Laboong Admin · Phân tích RFM</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-rfm.jsx') }}?v={{ filemtime(public_path('js/admin-report-rfm.jsx')) }}"></script>
</body>
</html>
