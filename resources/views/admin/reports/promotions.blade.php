...
<title>Laboong Admin · Hiệu quả khuyến mãi</title>
...
<script>window.ADMIN_REPORT_DATA = @json($reportData);</script>
...
<script type="text/babel" src="{{ asset('js/admin-report-promotions.jsx') }}?v={{ filemtime(public_path('js/admin-report-promotions.jsx')) }}"></script>
</body>
</html>
