...
<title>Laboong Admin · Top khách chi tiêu</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-top.jsx') }}?v={{ filemtime(public_path('js/admin-report-top.jsx')) }}"></script>
</body>
</html>
