...
<title>Laboong Admin · Sản phẩm bán chạy</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-products.jsx') }}?v={{ filemtime(public_path('js/admin-report-products.jsx')) }}"></script>
</body>
</html>
