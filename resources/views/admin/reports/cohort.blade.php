...
<title>Laboong Admin · Cohort retention</title>
...
<script type="text/babel" src="{{ asset('js/admin-report-cohort.jsx') }}?v={{ filemtime(public_path('js/admin-report-cohort.jsx')) }}"></script>
</body>
</html>
