...
<title>Laboong Admin · Email</title>
...
{{-- TinyMCE (self-host, không cần API key) cho ô nội dung email --}}
<script src="https://cdn.jsdelivr.net/npm/tinymce@7/tinymce.min.js" referrerpolicy="origin"></script>

<script>
  window.ADMIN_EMAIL_DATA = @json($emailData);
</script>
...
<script type="text/babel" src="{{ asset('js/admin-email.jsx') }}?v={{ filemtime(public_path('js/admin-email.jsx')) }}"></script>
</body>
</html>
