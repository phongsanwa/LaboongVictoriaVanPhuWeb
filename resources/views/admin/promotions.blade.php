...
<title>Laboong Admin · Khuyến mãi</title>
...
<script>
  window.ADMIN_PROMOTIONS_DATA = @json($promotionsData);
</script>
...
<script type="text/babel" src="{{ asset('js/admin-promotions.jsx') }}?v={{ filemtime(public_path('js/admin-promotions.jsx')) }}"></script>
</body>
</html>
