...
{{-- Trình soạn thảo cho hướng dẫn cài đặt iPhone (có fallback textarea nếu CDN bị chặn) --}}
...
<script type="text/babel" src="{{ asset('js/admin-settings.jsx') }}?v={{ filemtime(public_path('js/admin-settings.jsx')) }}"></script>
</body>
</html>
