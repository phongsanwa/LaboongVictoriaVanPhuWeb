...
<title>Laboong Admin · Banner</title>
...
<script>
  window.ADMIN_BANNERS_DATA = @json($bannersData);
</script>
...
<script type="text/babel" src="{{ asset('js/admin-banners.jsx') }}?v={{ filemtime(public_path('js/admin-banners.jsx')) }}"></script>
</body>
</html>
