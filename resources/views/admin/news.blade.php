...
<title>Laboong Admin · Tin tức</title>
...
{{-- TinyMCE (bản self-host, không cần API key) cho ô nội dung bài viết --}}
<script src="https://cdn.jsdelivr.net/npm/tinymce@7/tinymce.min.js" referrerpolicy="origin"></script>

<script>
  window.ADMIN_NEWS_DATA = @json($newsData);
</script>
...
<script type="text/babel" src="{{ asset('js/admin-news.jsx') }}?v={{ filemtime(public_path('js/admin-news.jsx')) }}"></script>
</body>
</html>
