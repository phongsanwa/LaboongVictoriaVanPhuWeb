...
<title>403 · Không có quyền truy cập — Laboong</title>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body {
    ...
    background: linear-gradient(160deg, #7A4A28 0%, #C99A2E 100%);
    padding: 24px;
  }
  .card {
  ...
  .code {
    ...
    background: linear-gradient(150deg, #7A4A28, #C99A2E);
...
<body>
  <main class="card">
    ...
    <p>
      ...
      @else
        Trang này yêu cầu quyền cao hơn tài khoản của bạn.<br/>Nếu bạn nghĩ đây là nhầm lẫn, hãy liên hệ quản trị viên.
      @endif
    </p>
    <div class="acts">
      <a class="btn primary" href="{{ url('/') }}">← Về trang chủ</a>
      <a class="btn ghost" href="{{ url('/login') }}">Đăng nhập tài khoản khác</a>
    </div>
  </main>
</body>
</html>
